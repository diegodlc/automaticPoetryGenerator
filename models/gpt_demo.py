...
if __name__ == '__main__':
    st.title('Automatic Poetry Generator')
    generatePoem = st.button('Click to generate poetry')
    if generatePoem:
        st.write('presionado')

    
    starting_text = st.text_area('Or enter your your text and let the model complete it ...')
